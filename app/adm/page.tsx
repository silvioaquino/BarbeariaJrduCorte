  ...
  return ( 
    <>
      ...
      <div className="px-5 py-6">
        ...
        <h2 className="text-xl font-bold text-center mb-2 mt-2">Confirmados</h2>

        {confirmedBookings.map((booking) => (
          <BookingItemAdm key={booking.id} booking={JSON.parse(JSON.stringify(booking))} />
        ))}
        
        <h2 className="text-xl font-bold text-center mb-2 mt-2">Finalizados</h2>
